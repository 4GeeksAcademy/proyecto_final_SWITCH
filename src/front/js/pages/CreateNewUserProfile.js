...
export const CreateNewUserProfile = () => {
  ...
  return (
    <>
      {/* PAGE CONTAINER */}
      <div className="container-sm mt-3 col-lg-8 col-xl-8 col-xxl-6 border border-1 border-dark-subtle rounded-2">
          ...
          <fieldset className="mb-3">
            <legend className="col-form-label col-sm-2 pt-0">Tipo de Usuario<span className="requiredAsterisk">*</span></legend>
              <div className="form-check mb-2">
                ...
                <label className="form-check-label" for="radioMember">
              ...
              <div className="form-check">
                ...
                <label className="form-check-label" for="radioOrganizer">

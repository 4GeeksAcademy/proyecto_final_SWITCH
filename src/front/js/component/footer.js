...
export const Footer = () => {
	...
	<footer className="footer mt-auto py-3 text-center">
		<div class="container text-center">
			<div class="row gap-4 flex-column flex-sm-row">
				<div class="col ">
					...
					<div className="d-flex justify-content-center gap-3">
						{/* Facebook */}
						<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="##000080" class="bi bi-facebook" viewBox="0 0 16 16" className="footer-icon">
							<path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951" />
						</svg>
						{/* Instagram */}
						<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="##000080" class="bi bi-instagram" viewBox="0 0 16 16" className="footer-icon">
						...
						{/* Twitter/X */}
						<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="##000080" class="bi bi-twitter-x" viewBox="0 0 16 16" className="footer-icon">
							<path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865l8.875 11.633Z" />
						</svg>
						{/* Youtube */}
						<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="##000080" class="bi bi-youtube" viewBox="0 0 16 16" className="footer-icon">
...
{/* 
		<div className="footer-container d-flex flex-column gap-4 flex-sm-row">
			<div className="footer-container--siteSummary mx-5 mx-sm-2 mb-2 mb-sm-0 w-25">
				
				</div>
			</div>
			<div className="footer-container--quicklinks mx-5 mx-sm-2 mb-2 mb-sm-0 d-flex flex-column w-25">
				
			<div className="footer-container--contact mx-5 mx-sm-2 mb-2 mb-sm-0 d-flex flex-column w-25">
				
			</div>
			<div className="footer-container--text mx-5 mx-sm-2 mb-2 mb-sm-0 d-flex flex-column w-25">
